...
describe('CustomToEpochCommand', () => {
    ...
    describe('execute', () => {
        ...
        beforeEach('Reset', () => {
            testObject = new CustomToEpochCommand(new ExtensionContextMock(), timeConverter, new ConfigHelper());
            testEditor.selection = new vscode.Selection(new vscode.Position(6, 40), new vscode.Position(6, 44));
            handlerMock.run.returns(new Promise(resolve => resolve(['YYYY', '2018', 'ms'])));
