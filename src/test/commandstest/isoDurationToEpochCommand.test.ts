...
describe('IsoDurationToEpochCommand', () => {
    let timeConverter: TimeConverter;
    let testObject: IsoDurationToEpochCommand;
    ...
    describe('execute', () => {
        ...
        beforeEach('Reset', () => {
            testObject = new IsoDurationToEpochCommand(new ExtensionContextMock(), timeConverter);
        ...
        it('Should show result after calculation', async () => {
            ...
            assert.strictEqual(
                ...
                timeConverter.isoDurationToEpoch('P1Y2M3DT4H5M6S', 'ms'));
        });
