...
describe('IsoRfcToEpochCommand', () => {
    ...
    describe('execute', () => {
        ...
        beforeEach('Reset', () => {
            testObject = new IsoRfcToEpochCommand(new ExtensionContextMock(), timeConverter, new ConfigHelper());
            testEditor.selection = new vscode.Selection(new vscode.Position(6, 40), new vscode.Position(6, 44));
            handlerMock.run.returns(new Promise(resolve => resolve(['1975-01-01T00:00:00.000Z', 'ms'])));
        ...
        it('Should show result after calculation', async () => {
            ...
            assert.strictEqual(
                ...
                timeConverter.isoRfcToEpoch('1975-01-01T00:00:00.000Z', 'ms'));
        });
